...
def get_pg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--min_step-per-epoch', type=int, default=1)
    ...
    parser.add_argument('--training_envs', type=int, default=100, help='number of parallel training environments')
    parser.add_argument('--test_envs', type=int, default=100, help='number of parallel testing environments')
    ...
    parser.add_argument('--resume-path', type=str, default='log/card_combat/dqn/policy.pth', help='the path of agent pth file for resuming from a pre-trained agent')
    parser.add_argument('--opponent-path', type=str, default='log/card_combat/dqn/policy.pth', help='the path of opponent agent pth file for resuming from a pre-trained agent')
    
    # For human eyes
    parser.add_argument('--render_rate', type=float, default=0.01, help='delay between rendered frames')
