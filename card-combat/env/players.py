...
class Player:
    def __init__(self, max_health: int, max_energy: int, starting_deck: deck, hand_size: int, give_coin = False):
        ...
        self.reset(give_coin=give_coin)
    ...
    def reset(self, give_coin = False):
